...
export default function PatientMenu() {
  ...
  const isActive = (path) => {
    ...
    if (path !== "/patient" && location.pathname.startsWith(path)) return true;
    return false;
  };
  ...
  const MenuContent = () => (
    <div className="flex flex-col h-full text-slate-300">
      ...
      <div className="h-20 flex items-center gap-3 px-6 border-b border-slate-800">
        <div className="p-1.5 bg-emerald-600 rounded-lg shadow-lg shadow-emerald-900/50">
          {/* You can replace this icon with your <img src="..." /> if preferred */}
      ...
      <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
        {patientMenuDetails.map((item, index) => {
