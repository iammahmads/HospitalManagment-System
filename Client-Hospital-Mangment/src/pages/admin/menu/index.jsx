...
const menuItems = [
  ...
  { text: "Blood Bank", path: "/admin/blood-managment", icon: Droplet },
  { text: "Patients", path: "/admin/patients", icon: Users },
  { text: "Doctors", path: "/admin/doctors", icon: Stethoscope },
  { text: "Notifications", path: "/admin/notifications", icon: Bell },
  { text: "Appointments", path: "/admin/appointments", icon: CalendarCheck },
];
...
export default function AdminMenu() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between h-16 px-4 bg-slate-900 border-b border-slate-800 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="p-1.5 bg-white rounded-md">
            <img src="/nobackground_logo.png" alt="Logo" className="w-5 h-5" />
          </div>
          <span className="font-bold text-white">HMS Admin</span>
        </div>
        <button
      ...
      {/* Standard Tailwind Slate-900 background */}
